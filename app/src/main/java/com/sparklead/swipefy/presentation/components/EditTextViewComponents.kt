...
@Composable
fun NormalEditTextView(labelValue: String, painterResources: Painter,textValue: MutableState<String>) {
...
@Composable
fun PasswordTextView(labelValue: String, painterResources: Painter,passwordValue:MutableState<String>) {
